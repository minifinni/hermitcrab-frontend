...
## Description
Compile daily briefing with meeting context, active deals, and citation tracking. Provides a comprehensive daily overview with proper sourcing.
...
## Why It's Valuable
**The ultimate daily prep skill.** Before any meeting or at the start of the day, this skill surfaces everything you need to know: meeting participants with their context, active deals, pending deadlines, and recent changes. Every fact is cited so you can verify freshness. Prevents walking into meetings blind.
