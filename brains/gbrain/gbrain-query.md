...
## Why It's Valuable
**The knowledge retrieval skill.** This is how users tap into their brain's accumulated intelligence. It guarantees answers are grounded in stored knowledge (not hallucinations), provides citations for every claim, and flags gaps honestly. Essential for turning a knowledge base into actionable insights.
