...
## Why It's Valuable
**The intelligence gathering skill.** Turns scattered mentions into rich, actionable profiles. Uses tiered enrichment (scale effort to importance) so you don't waste resources on minor contacts. The "iron law of back-linking" ensures no connection is lost. Creates intelligence dossiers, not just data dumps.
